...
const AllRequests = () => {
  ...
  const loadRequests = async () => {
    try {
      ...
      const res = await fetch(
        'https://assetverse-server-nu.vercel.app/hr/requests'
      );
  ...
  const updateStatus = async (id, action) => {
    try {
      const url =
        action === 'approve'
          ? `https://assetverse-server-nu.vercel.app/hr/requests/${id}/approve`
          : `https://assetverse-server-nu.vercel.app/hr/requests/${id}/reject`;
